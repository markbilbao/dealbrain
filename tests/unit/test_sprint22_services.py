...
def test_classify_path_buckets() -> None:
    ...
    assert classify_path("POST", "/api/v1/auth/email-change/confirm") == "auth_email"
    assert classify_path("POST", "/api/v1/auth/email-change/") == "auth_email"
    assert classify_path("POST", "/api/v1/auth/email-change/confirm/") == "auth_email"
    assert classify_path("GET", "/api/v1/auth/email-change") == "default"
    assert classify_path("GET", "/api/v1/auth/email-change/confirm") == "default"
    assert classify_path("POST", "/api/v1/auth/email-change?user_id=other") == "auth_email"
    assert classify_path("POST", "/api/v1/auth/email-change/confirm?token=x") == "auth_email"
