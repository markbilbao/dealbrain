...
LIMITATIONS: tuple[str, ...] = (
    ...
    "No ranking manipulation — merchants cannot alter organic DealScore.",
...
def build_demo_accounts() -> list[MerchantAccount]:
    return [
        ...
        MerchantAccount(
            ...
            display_name="DealBrain Internal Admin",
            created_at=_dt(-1000),
            updated_at=_dt(-1),
            is_active=True,
    ...
    return [
        MerchantOrganization(
            ...
            profile=MerchantProfile(
                ...
                business_description="Demo electronics retailer for DealBrain Merchant Platform.",
...
def build_demo_promotions() -> list[MerchantPromotion]:
    return [
        MerchantPromotion(
            ...
            description="Demo limited-time sale — does not auto-boost DealScore.",
            sale_price=1199.0,
            currency="USD",
