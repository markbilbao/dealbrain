...
| 27 | Transactional Identity & Email | Real email; reset/verify/email-change; token lifecycle; enumeration-safe errors; session rotation | P0-5; HIGH demo-auth | EXT-08, EXT-09 | **In progress — 27.1 + 27.2 + 27.3 cutover readiness + 27.4 consumer email-change/success-state UX implemented, sprint not complete.** EXT-09 DNS not verified; real inbox E2E not done; live staging email-change inbox E2E still required; production secret attach remains Sprint 41 |
