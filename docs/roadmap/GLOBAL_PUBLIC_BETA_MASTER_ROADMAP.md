...
| 27 | Transactional Identity & Email | Real email; reset/verify/email-change; token lifecycle; enumeration-safe errors; session rotation | P0-5; HIGH demo-auth | EXT-08, EXT-09 | **In progress — 27.1 + 27.2 + 27.3 code/config cutover readiness implemented, sprint not complete.** EXT-09 DNS not verified; real inbox E2E not done; production secret attach remains Sprint 41 |
