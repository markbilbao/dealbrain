...
| 27–28 | Identity/email; privacy/legal | 27 COMPLETE / CLOSED. 28 INTERNAL ENGINEERING COMPLETE — EXTERNAL LEGAL/PUBLICATION GATES REMAIN |
...
| 28 | Privacy, Legal, Consent & Deletion | ToS/Privacy/consent/deletion/export + search-index privacy | P0-4; MEDIUM GDPR | EXT-17…22 | **INTERNAL ENGINEERING COMPLETE — EXTERNAL LEGAL/PUBLICATION GATES REMAIN.** Not COMPLETE/CLOSED. 28.1 foundations + 28.2 staging export/delete HTTP evidence remain. Consent/audit inspection, engineering retention map, essential-only tracking hook, and eligibility placeholders exist. Counsel drafts remain unpublished. EXT-19 written approval absent. EXT-20/21 `not_started`. EXT-22 `not_started` (Sprint 39 owns CMP/analytics activation). 44/45 publication remain open |
...
| Privacy/deletion/legal | Internal engineering | Tests | 28.2 delete/export HTTP; publication pending | Pending (45) | Pending (44) |
...
| 21 | Privacy/consent | 28 / 39 | Internal inspection + 28.1 persistence implemented; unpublished so production records stay empty | Consent persistence + staging proof after publication | Yes — NON-WAIVABLE | Delay launch |
...
4. **Sprint 28** — INTERNAL ENGINEERING COMPLETE — EXTERNAL LEGAL/PUBLICATION GATES REMAIN. ToS/Privacy/cookie/consent/deletion/export/retention/PII/vendor register/contacts/age-notice placeholders; search-index privacy; counsel package; consent/audit inspection. Final publication/approval in 44/45. Not COMPLETE/CLOSED.
