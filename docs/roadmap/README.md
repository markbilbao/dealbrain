...
| [`GAP_INVENTORY.md`](GAP_INVENTORY.md) | Phase 1 gap inventory (sections A–M) + 2026-08-24 reconciliation addendum + later status addenda including 2026-09-07 PH validation-beta lock |
...
| [`evidence/`](evidence/) | Packaged sprint evidence (Sprint 26 staging proof; Sprint 26 Shopee evidence; Sprint 26 still open for EXT-01) |
