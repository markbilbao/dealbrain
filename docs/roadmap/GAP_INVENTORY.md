...
| MerchantCapability / supported-market metadata | `planned_sufficient_ac` | Sprint 31 research-provider capability/market metadata implemented; unsupported-market product policy still finalizes in 37; production providers uncertified | 31 |
| Merchant contractual capability/policy (fail-closed; distinct from technical ConnectorCapability) | `planned_sufficient_ac` | Sprint 31 fail-closed contract exported; Sprints 32–36 still own provider/market evidence; affiliate ≠ data permission | 31 / 32–36 / 45 |
