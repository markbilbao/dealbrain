...
- External dependency bootstrap actions (EXT-01…EXT-05 market rows remain `not_started`; Shopee, Lazada, TikTok Shop, Amazon, and Temu applications counsel-cleared to proceed 2026-08-25; real application **submission** evidence still required)
...
- EXT-19 legal counsel engagement: COMPLETE FOR SPRINT 26 BOOTSTRAP / `applied` (Pauline Anne Sambuang; engagement accepted 2026-08-10; consultation confirmed 2026-08-19 10:00 Philippines local time; supporting documents requested; sanitized engagement + schedule confirmation retained 2026-08-10 — not EXT-19 `approved`; not Terms/Privacy approved; not launch approval)
- Merchant-program application counsel clearance: COMPLETE FOR THE LEGAL GATE TO APPLY / does **not** close Sprint 26 (signed record 2026-08-25; Shopee, Lazada, TikTok Shop, Amazon, and Temu applications counsel-cleared to proceed; conditions N/A; no hold; sanitized [`SPRINT_26_MERCHANT_APPLICATION_COUNSEL_CLEARANCE.md`](SPRINT_26_MERCHANT_APPLICATION_COUNSEL_CLEARANCE.md); signed PDF outside Git — **not** merchant approval, **not** register EXT-01…EXT-05 `applied`, **not** a merchant-to-market assignment)
- Actual action/application dates for remaining items (must be real; never invented)
- External register updates based on evidence (EXT-08 now `applied`; EXT-09 now `applied` for preparation only; EXT-10 now `approved`; EXT-17 now `provisioned`; EXT-18 now `provisioned`; EXT-19 now `applied` for engagement/schedule only; remaining Sprint 26 bootstrap rows EXT-01…EXT-05 still `not_started` with counsel-clearance notes only)
...
- EXT-19 `applied` does **not** close Sprint 26, does **not** start Sprint 27, does **not** mean EXT-19 `approved`, and does **not** prove Terms/Privacy approval, launch legal approval, or privacy-regime compliance. Merchant-application counsel clearance (2026-08-25) does **not** mean EXT-01…EXT-05 `applied`.
