...
- External dependency bootstrap actions (EXT-01…EXT-05 — counsel-cleared to **apply** 2026-08-25; real application **submission** evidence still required; rows remain `not_started`)
...
- Merchant-program application counsel clearance: COMPLETE FOR THE LEGAL GATE TO APPLY / does **not** close Sprint 26 (signed record 2026-08-25; Shopee, Lazada, TikTok Shop, Amazon, Temu counsel-cleared to submit applications; conditions N/A; no hold; sanitized [`SPRINT_26_MERCHANT_APPLICATION_COUNSEL_CLEARANCE.md`](SPRINT_26_MERCHANT_APPLICATION_COUNSEL_CLEARANCE.md); signed PDF outside Git — **not** merchant approval, **not** EXT-01…EXT-05 `applied`)
