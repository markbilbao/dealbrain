...
|----|------------|-------|---------------|-------|------------------|--------------------------|----------------|--------------|-------------------|----------|--------|
| EXT-01 | PH merchant/API or affiliate access | Marketplace eng + legal | 32 | Philippines market | Sprint 26 kickoff | 2–8 weeks | `not_started` | **RED** to name PH; shopping launch **RED** until ≥1 market is certified | Counsel-cleared to apply 2026-08-25 (see EXT-01…EXT-05 notes). Still required: application submission evidence; then signed terms + sandbox/live credential proof + live normalized offer | Delay PH as named supported market; site may still launch with other markets | Market PH |
| EXT-02 | US merchant/API or affiliate access | Marketplace eng + legal | 33 | United States market | Sprint 26 kickoff | 2–8 weeks | `not_started` | **RED** to name US | Counsel-cleared to apply 2026-08-25 (see EXT-01…EXT-05 notes). Still required: application submission evidence; then same as EXT-01 for US | Delay US market naming | Market US |
| EXT-03 | SG merchant/API or affiliate access | Marketplace eng + legal | 34 | Singapore market | Sprint 26 kickoff | 2–8 weeks | `not_started` | **RED** to name SG | Counsel-cleared to apply 2026-08-25 (see EXT-01…EXT-05 notes). Still required: application submission evidence; then same for SG | Delay SG market naming | Market SG |
| EXT-04 | UK merchant/API or affiliate access | Marketplace eng + legal | 35 | United Kingdom market | Sprint 26 kickoff | 2–8 weeks | `not_started` | **RED** to name UK | Counsel-cleared to apply 2026-08-25 (see EXT-01…EXT-05 notes). Still required: application submission evidence; then same for UK | Delay UK market naming | Market UK |
| EXT-05 | CA merchant/API or affiliate access | Marketplace eng + legal | 36 | Canada market | Sprint 26 kickoff | 2–8 weeks | `not_started` | **RED** to name CA | Counsel-cleared to apply 2026-08-25 (see EXT-01…EXT-05 notes). Still required: application submission evidence; then same for CA | Delay CA market naming | Market CA |
...
**Merchant application counsel clearance (2026-08-25):** sanitized record at [`evidence/SPRINT_26_MERCHANT_APPLICATION_COUNSEL_CLEARANCE.md`](evidence/SPRINT_26_MERCHANT_APPLICATION_COUNSEL_CLEARANCE.md); owner application preparation at [`evidence/SPRINT_26_EXT01_05_APPLICATION_PREPARATION.md`](evidence/SPRINT_26_EXT01_05_APPLICATION_PREPARATION.md). Counsel-cleared to **apply** for Shopee, Lazada, TikTok Shop, Amazon, and Temu. That does **not** make EXT-01…EXT-05 `applied`.
...
- EXT-01…EXT-06 — no merchant applications or credentials evidenced. Counsel has cleared PiqSavi to **apply** to Shopee, Lazada, TikTok Shop, Amazon, and Temu (2026-08-25; see EXT-01…EXT-05 notes); applications are **not** submitted. Naming any of PH/US/SG/UK/CA is blocked. Public shopping launch remains blocked until **at least one** market is certified. Individual markets may be omitted.
...
| Merchant-program application clearance (separate from EXT-19 `approved`) | Signed counsel application-authorization record dated 2026-08-25: Shopee, Lazada, TikTok Shop, Amazon, Temu counsel-cleared to **submit applications**; consolidated conditions N/A; no hold. Sanitized engineering record: [`evidence/SPRINT_26_MERCHANT_APPLICATION_COUNSEL_CLEARANCE.md`](evidence/SPRINT_26_MERCHANT_APPLICATION_COUNSEL_CLEARANCE.md). Signed PDF retained outside Git. This does **not** approve Terms/Privacy, launch, or EXT-01…EXT-05 `applied`. |
...
| Separation | EXT-19 = counsel engagement / later written approval of consumer legal documents; merchant-program **application** clearance is tracked under EXT-01…EXT-05 notes without changing those rows’ lifecycle status; EXT-18 = privacy contact; EXT-20/EXT-21 = policy publication; EXT-01…EXT-05 = merchant/API applications — do not merge |

### EXT-01…EXT-05 notes (merchant application counsel clearance — lifecycle unchanged)

Counsel-form merchant IDs on the signed record (Shopee / Lazada / TikTok Shop / Amazon / Temu) are **not** the register market IDs (PH / US / SG / UK / CA). Do not rename these rows.

| Field | Value |
|-------|-------|
| Current status (register lifecycle) | `not_started` for EXT-01, EXT-02, EXT-03, EXT-04, and EXT-05 |
| Counsel-clearance status | Counsel-cleared to **submit applications** for Shopee, Lazada, TikTok Shop, Amazon, and Temu |
...
| Next action | Owner identifies official portal + market, supplies missing application fields, submits, and retains Section H evidence in [`evidence/SPRINT_26_EXT01_05_APPLICATION_PREPARATION.md`](evidence/SPRINT_26_EXT01_05_APPLICATION_PREPARATION.md) |
