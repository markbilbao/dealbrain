...
**Depends on:** Sprints 1–23 (merged), Architecture Lock (launch sequencing now Sprint 45 launch / Sprint 46 stabilize / Sprint 47 post-beta numbered stop per [Global Public Beta master roadmap](../roadmap/GLOBAL_PUBLIC_BETA_MASTER_ROADMAP.md); Sprint 40 hard endpoint superseded)
